...
//
    OT.$.getJSONP = function (url, options) {
        ...
        _waitUntilTimeout = setTimeout(function () {
            _this._onLoadTimeout();
        }, _loadTimeout);
    };
...
// their video element and other chrome.
    OT.WidgetView = function (domId, properties) {
        ...
        videoObserver = OT.$.observeNodeOrChildNodeRemoval(container, function (removedNodes) {
            ...
            // not be the case.
            var videoRemoved = OT._.some(removedNodes, function (node) {
...
//
    OT.$.getUserMedia = function (constraints, success, failure, accessDialogOpened, accessDialogClosed) {
        ...
        if (!constraints || OT._.all(constraints, function (constraint) {
...
//
    OT.VideoElement = function (options) {
        ...
        Object.defineProperties(this, {
            ...
            domElement: {get: function () {
                return _domElement;
            }},
            parentElement: {get: function () {
                return _parentElement;
            }},
            isBoundToStream: {get: function () {
                return _streamBound;
            }},
            poster: {
                get: function () {
...
//
    OT.WebSocketMessage.signalMessage = function (sessionId, fromConnectionId, options) {
        ...
        if (this.valid) {
            ...
            var payload = {
                id: this.id,
                toAddresses: OT._.map(this.signal.to, function (thing) {
...
// can be destroyed
    OT.Chrome.NamePanel = function (options) {
        ...
        this.__defineSetter__("domElement", function (domElement) {
    ...
    OT.generateSimpleStateMachine = function (initialState, states, transitions) {
        ...
        return function (stateChangeFailed) {
            ...
            Object.defineProperties(this, {
                ...
                subscribing: {
                    get: function () {
                        return currentState === 'Subscribing';
                    }
                }
            });
        };
 ...
 *  }
    ...
    OT.Publisher = function () {
        ...
        this.__defineSetter__("stream", function (stream) {
            _stream = stream;
        });
...
(function (window) {
    ...
    OT.Subscriber = function (replaceElementId, options) {
        ...
        this.__defineGetter__("targetElement", function () {
            return _streamContainer ? _streamContainer.domElement : null;
        });
        this.__defineGetter__("subscribing", function () {
            return _state.subscribing;
        });
 ...
 *  }
  ...
  * }
        ...
        this.__defineGetter__("connection", function () {
            return _wrangler.connections[_connectionId];
        });
